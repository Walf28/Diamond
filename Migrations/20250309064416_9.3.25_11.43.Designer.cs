...
{
    [DbContext(typeof(DB))]
    [Migration("20250309064416_9.3.25_11.43")]
    partial class _9325_1143
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyCompany.Factory", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("RegionsId")
                        .HasColumnType("integer[]");

                    b.PrimitiveCollection<List<int>>("RequestsId")
                        .HasColumnType("integer[]");

                    b.PrimitiveCollection<List<int>>("RoutesId")
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("MyCompany.Region", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("MaterialsId")
                        .HasColumnType("integer[]");
                    ...
                    b.PrimitiveCollection<List<int>>("RegionsChildrensId")
                        .HasColumnType("integer[]");

                    b.PrimitiveCollection<List<int>>("RegionsParentsId")
                        .HasColumnType("integer[]");
